...
async def update_grade(grade_id: int, grade: GradeUpdate, db: Session = Depends(get_db)):
    grade = grade_crud.update_grade(db=db, grade_id=grade_id, grade=grade)
    return grade
